...
export type IdlV00Type = IdlV00TypeArray | IdlV00TypeDefined | IdlV00TypeMap | IdlV00TypeNumber | IdlV00TypeOption | IdlV00TypeSet | IdlV00TypeTuple | IdlV00TypeVec | 'bool' | 'bytes' | 'publicKey' | 'string';
...
export type IdlV00TypeTuple = {
    tuple: IdlV00Type[];
};
export type IdlV00TypeArray = {
    array: [idlV00Type: IdlV00Type, size: number];
};
export type IdlV00TypeHashMap = {
    hashMap: [IdlV00Type, IdlV00Type];
};
export type IdlV00TypeBTreeMap = {
    bTreeMap: [IdlV00Type, IdlV00Type];
};
export type IdlV00TypeMap = {
    size?: IdlV00TypeUnsignedInteger | number | 'remainder';
} & (IdlV00TypeBTreeMap | IdlV00TypeHashMap);
export type IdlV00TypeHashSet = {
    hashSet: IdlV00Type;
};
export type IdlV00TypeBTreeSet = {
    bTreeSet: IdlV00Type;
};
